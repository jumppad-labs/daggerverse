...
type ChecksumID = dagger.ChecksumID
...
type Github = dagger.Github

type WithGithubFunc = dagger.WithGithubFunc

// GithubCommitFileOpts contains options for Github.CommitFile
type GithubCommitFileOpts = dagger.GithubCommitFileOpts

// GithubCreateReleaseOpts contains options for Github.CreateRelease
type GithubCreateReleaseOpts = dagger.GithubCreateReleaseOpts

// GithubFtestCreateReleaseOpts contains options for Github.FtestCreateRelease
type GithubFtestCreateReleaseOpts = dagger.GithubFtestCreateReleaseOpts
